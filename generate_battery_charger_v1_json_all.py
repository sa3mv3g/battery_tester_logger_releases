    ...
    def update_holding_registers(self):
        hrlist = [
            ...
            HoldingRegister(
                ...
                logging_parameters=LoggingParameter("CHARGING_CHARGE", "", historyBufferLen=1, display_format="%.5f")
                , dataType=REGISTER_DATATYPE_F32
            ),
            HoldingRegister(
                address=19,
            ...
            HoldingRegister(
                ...
                logging_parameters=LoggingParameter("DISCHARGING_CHARGE", "", historyBufferLen=1, display_format="%.5f")
                , dataType=REGISTER_DATATYPE_F32
            ),
            HoldingRegister(
                address=25,
            ...
            HoldingRegister(
                ...
                logging_parameters=LoggingParameter("NET_CHARGE", "", historyBufferLen=1, display_format="%.5f")
                , dataType=REGISTER_DATATYPE_F32
            ),
            HoldingRegister(
                address=31,
...
def test_generate_battery_charger_v1_json():
    json_file_path = os.path.join(os.path.dirname(__file__), '..', 'test','jsonConfigs', 'battery_charger_v1_2_all.json')
    ...
    fc.addMonitorGroup(monitorAllBatteryChargerInstruments())
    fc.addSerialPort(sp)
